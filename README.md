...
| `JARVIS_ALLOWED_ORIGINS` | localhost dev ports | Extra accepted `Origin` header values |
| `JARVIS_ALLOW_NO_ORIGIN` | off | Accepts clients that omit the `Origin` header when `1` |
